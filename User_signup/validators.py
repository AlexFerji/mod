"""
Сообщения об ошибках, данные и пользовательский код проверки, используемые в
различных классах форм регистрации пользователей django-registration.
...
CONFUSABLE_EMAIL = _(
    "Этот адрес электронной почты не может быть зарегистрирован."
    "Пожалуйста, укажите другой адрес электронной почты."
)
DUPLICATE_EMAIL = _(
    "Этот адрес электронной почты уже используется. " "Пожалуйста, укажите другой адрес электронной почты."
)
DUPLICATE_USERNAME = _("Пользователь с таким именем пользователя уже существует.")
FREE_EMAIL = _(
    "Регистрация с использованием бесплатных адресов электронной почты запрещена."
    "Пожалуйста, укажите другой адрес электронной почты."
)
RESERVED_NAME = _("Это имя зарезервировано и не может быть зарегистрировано.")
TOS_REQUIRED = _("Вы должны согласиться с условиями регистрации")
